...
const updateTStatus = (status) => new Promise((resolve, reject) => {
    ...
    getTrendHashtag().then(trend => {
        ...
        twitte(`${new Date().getTime()}Já ouviu o último episódio do 🇮🇪Vinking no Sertão 🌵? Corre lá e escuta ${status} #podcast #podcasting #spotify #radio #music #podcaster ${trend}`)
            .then(result => {
                setTimeout(function () {
